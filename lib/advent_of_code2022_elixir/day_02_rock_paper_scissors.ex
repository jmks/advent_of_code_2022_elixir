defmodule AdventOfCode2022Elixir.Day02RockPaperScissors do
  @moduledoc """
  ...
  The second column, you reason, must be what you should play in response: X for Rock, Y for Paper, and Z fr Scissors. Winning every time would be suspicious, so the responses must have been carefully chosen.
  ...
  def score_round(shape, outcome) do
  ...
  def evaluate_round(:paper, :rock), do: {:rock, :loss}
  def evaluate_round(:paper, :scissors), do: {:scissors, :win}
