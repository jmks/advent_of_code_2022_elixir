defmodule AdventOfCode2022Elixir.Day06TurningTrouble do
  @moduledoc """
  ...
  To fix the communication system, you need to add a subroutine to the device that detects a start-of-packet marker in the datastream. In the protocol being used b the Elves, the start of a packet is indicated by a sequence of four characters that are all different.
